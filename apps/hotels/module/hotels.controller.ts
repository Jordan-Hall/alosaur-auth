...
import { HotelRO } from "./dto/hotels-response.ts";
import { Hotel } from './hotels.entity.ts';
import { UserService } from './hotels.service.ts';
...
export class HotelsController {
    ...
    @Post('/login')
    async findByLogin(@Body(LoginUserDto) loginDTO: LoginUserDto): Promise<HotelRO> {
